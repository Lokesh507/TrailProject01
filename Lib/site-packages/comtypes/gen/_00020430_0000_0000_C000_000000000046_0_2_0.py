...
IFontDisp = Font
__all__ = [ 'IFont', 'OLE_YSIZE_HIMETRIC', 'LoadPictureConstants',
           'Gray', 'FONTUNDERSCORE', 'Picture', 'StdPicture',
           'OLE_YSIZE_CONTAINER', 'Default', 'OLE_YPOS_PIXELS',
           'OLE_YPOS_HIMETRIC', 'OLE_OPTEXCLUSIVE', 'Color',
           'IPicture', 'OLE_YSIZE_PIXELS', 'StdFont',
           'OLE_ENABLEDEFAULTBOOL', 'IFontDisp', 'OLE_TRISTATE',
           'FONTSTRIKETHROUGH', 'OLE_YPOS_CONTAINER',
           'OLE_XSIZE_PIXELS', 'FONTITALIC', 'OLE_COLOR',
           'IPictureDisp', 'OLE_XSIZE_HIMETRIC', 'FONTNAME',
           'OLE_CANCELBOOL', 'Monochrome', 'Checked', 'Font',
           'FontEvents', 'OLE_HANDLE', 'OLE_XSIZE_CONTAINER',
           'OLE_XPOS_PIXELS', 'OLE_XPOS_HIMETRIC', 'Unchecked',
           'OLE_XPOS_CONTAINER', 'VgaColor', 'FONTBOLD',
